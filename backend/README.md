...
## Project Structure
    ...
    ├── american_residentia_33273  # Django project configurations
...
1. Clone this repo and `cd american_residentia_33273`
...
2. Clone this repo and `cd american_residentia_33273`
